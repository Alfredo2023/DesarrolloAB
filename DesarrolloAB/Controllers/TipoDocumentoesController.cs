...
namespace DesarrolloAB.Controllers
{
    public class TipoDocumentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdTipoDocumentos,Descripcion,Codigo")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipoDocumentos,Descripcion,Codigo")] TipoDocumento tipoDocumento)
        {
            if (ModelState.IsValid)
            {
